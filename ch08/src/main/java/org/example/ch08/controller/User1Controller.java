...
public class User1Controller {
    ...
    /*
        ...
        - 사용자 정의 응답 객체를 생성하기 때문에 프론트 개발 활용도 향상
    ...
    */
    ...
    public ResponseEntity<Map<String, Boolean>> remove(@PathVariable("userid") String userid, Map map){
        log.info(userid);
